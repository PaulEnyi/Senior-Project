...
const QuickQuestions = ({ onSelect }) => {
  const questions = [
    ...
    },
    {
      icon: <FaUsers />,
      category: 'Social',
      text: 'Are there any upcoming hackathons I can participate in?',
      color: 'teal'
    },
    {
      icon: <FaQuestionCircle />,
      category: 'Events',
      text: 'What networking events are available for CS majors?',
      color: 'indigo'
    },
    {
      icon: <FaUsers />,
      category: 'Study Groups',
      text: 'How do I form or join a study group for my CS classes?',
      color: 'cyan'
    },
    {
      icon: <FaLaptopCode />,
      category: 'Projects',
      text: 'How do I find project partners for team assignments?',
      color: 'lime'
    },
    {
      icon: <FaUsers />,
