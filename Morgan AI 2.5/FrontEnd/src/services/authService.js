...
export const authService = {
  ...
  async logout() {
    try {
      ...
      if (token) {
        // Call backend logout endpoint to save chat and revoke session
        try {
          ...
          if (response.data?.chat_saved) {
            console.log('✅ Server logout successful - chat saved to history')
          }
        } catch (error) {
      ...
      // Keep chat_favorites (user preference)
      console.log('  ℹ️ Preserving: chat_favorites')
