...
### 🌐 **Web Search with JavaScript Rendering** (NEW - December 2025)
- **Playwright Integration:** Browser automation for JavaScript-heavy pages
- **Faculty/Staff Extraction:** Extract faculty directory from faculty-and-staff page
- **Academic Advisers:** Complete adviser assignment list with student name grouping
- **Morgan State URLs:** All CS department pages configured with intelligent fallback
- **Caching Strategy:** Redis cache with JS page bypass for dynamic content
- **Performance:** Optimized Playwright rendering (4-9 seconds per complex page)
- **Error Handling:** Automatic fallback to backup sources on extraction failure
...
### **Critical Fixes & Improvements** (December 2, 2025)
- ✅ **Web Search Optimization** - Implemented Playwright for JavaScript rendering on faculty/staff pages
- ✅ **Faculty Information Extraction** - Fixed URL prioritization to use faculty-and-staff page as primary source
- ✅ **Academic Advisers Integration** - Complete adviser assignment list by student last name
- ✅ **Morgan State URL Configuration** - All Computer Science department URLs properly configured with fallback
- ✅ **Security Setup** - Added `.gitignore` and `.env.example` for GitHub upload safety
- ✅ **Documentation** - Comprehensive security section added to README
- ✅ **Login System Fixed** - Database users now created during signup, eliminating 500 errors
- ✅ **Rate Limit Resolution** - System prompt reduced 85% (1500 → 200 tokens), context capped at 1500 chars
- ✅ **Chat Performance** - No more 429 rate limit errors, all messages return 200 OK consistently
- ✅ **Token Optimization** - OPENAI_MAX_TOKENS reduced to 1000, message history limited to 3 messages
- ✅ **Verified Production Ready** - All 15+ core features tested and operational
...
### ⚠️ Security: Protecting Sensitive Data

#### Environment Files Structure
This project uses a **single `.env` file** at the project root:
```
Morgan AI 2.5/
├── .env                          # ✅ ONE file - used by docker-compose
...
### **Version 2.5** (November-December 2025) - Current
...
- ✅ **NEW:** Fixed login system with proper database sync
- ✅ **NEW:** Rate limit optimization (85% system prompt reduction)
- ✅ **NEW:** All 15+ core features verified and operational in production
...
**Latest Fixes:** Web search optimized, faculty extraction fixed, security hardened, all 15+ features verified
