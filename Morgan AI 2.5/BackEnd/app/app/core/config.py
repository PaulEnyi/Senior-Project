...
class Settings(BaseSettings):
    ...
    # Additional Internship Data Sources (Read from environment variables - DO NOT hard-code)
    HANDSHAKE_API_KEY: Optional[str] = Field(default=None, env="HANDSHAKE_API_KEY")
    ...
    # Internship Update Settings
    INTERNSHIP_UPDATE_INTERVAL_MINUTES: int = Field(default=30, env="INTERNSHIP_UPDATE_INTERVAL_MINUTES")
    INTERNSHIP_AUTO_UPDATE_ON_LOGIN: bool = Field(default=True, env="INTERNSHIP_AUTO_UPDATE_ON_LOGIN")
    INTERNSHIP_AUTO_UPDATE_ON_REFRESH: bool = Field(default=True, env="INTERNSHIP_AUTO_UPDATE_ON_REFRESH")
